...
*/
  ...
  distribution.local.groups.put(config, initialNodes, (e, v) => {
    ...
    distribution.local.groups.put(config, allNodes, (e, v) => {
...
*/
  ...
  // Instantiated groupD (this puts groupD on the local node)
  distribution.local.groups.put(config, groupD, (e, v) => {
    // This line sets the view of each node in groupD to the nodes in groupD (n1, n2, n3, n4, n5)
