...
serialize = require('@brown-ds/distribution/distribution/util/serialization.js').serialize; 
...
deserialize = require('@brown-ds/distribution/distribution/util/serialization.js').deserialize; 
...
//   if (obj.type === "object") {
//     let deserializedObj = {};
//     Object.values(obj.value).forEach(elem => {
